...
// ZoomHandler removed because zooming is disabled in normal view
  ...
  return (
    ...
    >
      ...
      {/* Controls Overlay */}
      <div className={`absolute left-1/2 -translate-x-1/2 flex flex-col items-center gap-3 md:gap-5 z-40 pointer-events-auto transition-all duration-300 w-[95%] md:w-auto ${isFullscreen ? 'bottom-4 md:bottom-8' : 'bottom-24 md:bottom-36'}`}>
