...
// ZoomHandler removed because zooming is disabled in normal view
  ...
  return (
    ...
    >
      ...
      {/* Controls Overlay */}
      <div className={`absolute left-1/2 -translate-x-1/2 flex flex-col items-center gap-3 md:gap-5 z-40 pointer-events-auto transition-all duration-300 w-[95%] md:w-auto ${isFullscreen ? 'top-4 md:top-8' : 'top-[25%] md:top-[30%] xl:top-28'}`}>
